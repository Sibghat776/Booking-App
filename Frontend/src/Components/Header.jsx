    ...
    return (
        <div className='max-w-screen bg-[#132a13] mx-auto px-16 pt-2'>
            <Stack
                ...
                className='w-screen-sm px-40 pt-4'
            >
            ...
            <Button variant="contained" style={{ backgroundColor: "#31572c", margin: "35px 160px" }}>Sign in / Register</Button>
            ...
            <Stack direction="row" className='bg-[#ecf39e] top-10 relative w-auto items-center justify-center p-1 py-2 border-[#90a955] border-4' spacing={2}>
                ...
                <Item className='relative' style={{ backgroundColor: "transparent", width: "30%", fontSize: "1.01rem", boxShadow: "none", height: "100%", color: "#132a13", cursor: "pointer" }} onClick={() => { setOpenDate(!openDate) }}><CalendarMonthIcon className='mx-4' />{`${format(date[0].startDate, "dd/MM/yyyy")} to ${format(date[0].endDate, "dd/MM/yyyy")}`}
                ...
                <Item onClick={() => { setOpenOptions(!openOptions) }} style={{ position: "relative", backgroundColor: "transparent", fontSize: "1.01rem", cursor: "pointer", width: "30%", boxShadow: "none", height: "100%", color: "#132a13" }}><GroupIcon className='mx-4' />{`${options.adult} Adult ${options.children} Children  ${options.room} Room`}</Item>
                ...
                <Button variant="contained" color="success" style={{ marginRight: "19px" }}>Search</Button>
            </Stack>
        </div>
    );
}
